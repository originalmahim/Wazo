const Confused = () => {
          return (
          <div>
          <section className="lg:-mb-44">
          <div className="mx-auto mt-7 max-w-screen-xl px-4 py-8 sm:py-12 sm:px-6 lg:py-16 lg:px-8">
          <div className="grid grid-cols-1 gap-8 lg:grid-cols-2 lg:gap-16">
          <div className="relative h-64 overflow-hidden rounded-lg sm:h-80 lg:order-last lg:h-full">
          <img
          alt="Party"
          src="https://i.ibb.co/LrW1Djy/Screenshot-2023-10-17-233602.png"
