...
const Login = () => {
  return (
          ...
          <div className="text-xl w-full max-w-md p-8  border-2 border-black rounded-xl">
          ...
          className="w-full px-4 py-3 border-2 border-black rounded-md focus:border-black focus:border-opacity-100"
          />
          </div>
          <div className="space-y-1 ">
          ...
          <button className=" btn bg-[#8289eb] block w-full p-3 text-center rounded-sm text-white hover:text-black">Sign in</button>
          </form>
