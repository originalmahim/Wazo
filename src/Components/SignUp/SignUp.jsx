    ...
    .then(result => {
      ...
      'You have Created Account successfully',
       ...
       setRegisterError(error.message);
          ...
          className="w-full text-white bg-[#e8a1fd] hover:bg-white hover:text-[#1c6e5f] focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center "
          >
          Create an account
          </button>
